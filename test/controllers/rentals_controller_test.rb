...
class RentalsControllerTest < ActionController::TestCase
  ...
  test "should create rental" do
    assert_difference('Rental.count') do
      post :create, rental: { end_time: @rental.end_time, name: @rental.name, start_time: @rental.start_time }
    end
  ...
  test "should update rental" do
    patch :update, id: @rental, rental: { end_time: @rental.end_time, name: @rental.name, start_time: @rental.start_time }
    assert_redirected_to rental_path(assigns(:rental))
  end
